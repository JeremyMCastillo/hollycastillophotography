<?php
class ControllerModuleTltBlogSettings extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('module/tltblog_settings');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/tltblog_settings', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('module/tltblog_settings', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('module/tltblog_settings', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/tltblog_settings')) {
