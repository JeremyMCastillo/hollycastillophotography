...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['text_rates_category'] = $this->language->get('text_rates_category');
		...
		$data['entry_rates_category'] = $this->language->get('entry_rates_category');
		...
		$data['help_rates_category'] = $this->language->get('help_rates_category');
		...
		if(isset($this->request->post['config_rates_category'])){
			$data['config_rates_category'] = $this->request->post['config_rates_category'];
		} else {
			$data['config_rates_category'] = $this->config->get('config_rates_category');
		}
