...
class ControllerTltBlogTltTag extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('tltblog/tlttag/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['copy'] = $this->url->link('tltblog/tlttag/copy', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('tltblog/tlttag/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['tlttags'][] = array(
				...
				'edit'       => $this->url->link('tltblog/tlttag/edit', 'token=' . $this->session->data['token'] . '&tlttag_id=' . $result['tlttag_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . '&sort=td.title' . $url, true);
		$data['sort_status'] = $this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . '&sort=t.status' . $url, true);
		$data['sort_sort_order'] = $this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . '&sort=t.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('tltblog/tlttag_list', $data));
	}
	...
	protected function getForm() {
		...
		$data['text_enabled'] = $this->language->get('text_enabled');
		$data['text_disabled'] = $this->language->get('text_disabled');
                                    $data['text_included'] = $this->language->get('text_included');
                                    $data['text_excluded'] = $this->language->get('text_excluded');
		...
		if (!isset($this->request->get['tlttag_id'])) {
			$data['action'] = $this->url->link('tltblog/tlttag/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('tltblog/tlttag/edit', 'token=' . $this->session->data['token'] . '&tlttag_id=' . $this->request->get['tlttag_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('tltblog/tlttag', 'token=' . $this->session->data['token'] . $url, true);
		...
		if (isset($this->request->post['status'])) {
			...
			$data['status'] = $this->request->post['category'];
		} elseif (!empty($tlttag_info)) {
			$data['category'] = $tlttag_info['show_in_category_list'];
		} else {
			$data['category'] = false;
		}
		...
		$this->response->setOutput($this->load->view('tltblog/tlttag_form', $data));
	}
