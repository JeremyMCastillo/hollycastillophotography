...
class ModelBlogPost extends Model {
	public function addPost($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "blog_post SET author = '" . $this->db->escape($data['author']) . "', image = '" . $this->db->escape($data['image']) . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_added = NOW()");
		...
		$this->event->trigger('post.admin.post.add', $blog_post_id);
	...
	public function editPost($blog_post_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "blog_post SET author = '" . $this->db->escape($data['author']) . "', image = '" . $this->db->escape($data['image']) . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE blog_post_id = '" . (int)$blog_post_id . "'");
		...
		$this->event->trigger('post.admin.post.edit', $blog_post_id);
	}

	public function deletePost($blog_post_id) {
		$this->event->trigger('pre.admin.post.delete', $blog_post_id);
		...
		$this->event->trigger('post.admin.post.delete', $blog_post_id);
	}
