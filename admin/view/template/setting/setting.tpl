        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-option">
				<fieldset>
					<legend><?php echo $text_rates_category; ?></legend>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-rates-category"><span data-toggle="tooltip" title="<?php echo $help_rates_category; ?>"><?php echo $entry_rates_category; ?></span></label>
						<div class="col-sm-10">
						  <select name="config_rates_category" id="input-rates-category" class="form-control">
							<?php foreach($categories as $category) { ?>
							  <option <?php if($category['category_id'] == $config_rates_category) { echo "selected='selected'"; } ?> value="<?php echo $category['category_id']; ?>"><?php echo $category['name']; ?></option>
							<?php } ?>
						  </select>
					</div>
				</fieldset>
