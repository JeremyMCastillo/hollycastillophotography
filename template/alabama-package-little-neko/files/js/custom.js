...
jQuery(function($){
	...
	if($('#superSizedSlider').length){
		...
		$.supersized({
                    ...
                    {image : './image/pages/common/shawna_derek.jpg', title : '<h1>We are a creative agency</h1><a href="#team" class="btn btn-primary">learn more</a>', thumb : '', url : ''},

                    {image : './image/pages/common/shawna_derek.jpg', title : '<h1>We build beautiful websites</h1><a href="#works" class="btn btn-primary">check our portfolio</a>', thumb : '', url : ''},

                    {image : './image/pages/common/shawna_derek.jpg', title : '<h1>That\'s how we like it</h1><a href="#contact" class="btn btn-primary">call us</a>', thumb : '', url : ''}
                    ],
